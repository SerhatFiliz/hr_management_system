...
# Employee model must be defined BEFORE JobPosting and Candidate
# because JobPosting and Candidate models refer to Employee.
class Employee(models.Model):
    ...
    company = models.ForeignKey(
        ...
        related_name='hr_employees', # Allows accessing Employee objects from a Company instance (e.g., my_company.hr_employees.all())
...
class JobPosting(models.Model):
    ...
    class Meta:
        """
        Meta options for the JobPosting model.
        """
    ...
    def __str__(self):
        """
        String representation of the JobPosting object.
        """
